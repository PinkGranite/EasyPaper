...
class ReActAgent(BaseAgent):
    ...
    async def react_loop(
        ...
        while iteration < max_iter:
            iteration += 1
            print(f"[ReActAgent] ReAct iteration {iteration}/{max_iter}")
            ...
            if assistant_message.tool_calls:
                print(f"[ReActAgent] LLM requested {len(assistant_message.tool_calls)} tool call(s)")
                ...
                print(f"[ReActAgent] ReAct loop completed after {iteration} iteration(s)")
